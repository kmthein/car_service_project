...
<br><br><br>
    ...
    if(isset($_POST['book'])){
        ...
        $result = mysqli_query($conn, "INSERT INTO `user_booking`(`service_name`, `price`, `user_name`,  `car_name`, `car_no`,
         `ph_no`, `email`, `address`, `req_type`, `date`, `request`,  `status`, `payment_method`, `payment_src`) 
        VALUES ('$service_name','$price','$user_name','$car_name','$car_no','$ph_no','$email','$address','$req_type','$service_date',
        '$request','$status',  '$pay_method', '$folder')" );
        if($result){
...
<?php
    ...
    } else "<script>alert('Booking Successful!');</script>";
}
                    ...
                    style="background-image: url(img/booking_img.jpg);">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="row g-3">
                                <?php
                                require 'config.php';
                                $stmt = $conn->prepare('SELECT service_name, price FROM booking_log Order By service_id DESC');
                                $stmt -> execute();
                                ...
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="user_name" class="form-control border-0" placeholder="Your Name" style="height: 55px;" required>
                                </div>
                                <div class="col-12 col-sm-6">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="date" id="date1" data-target-input="nearest">
                                        <input type="date"
                                            class="form-control border-0" name="service_date"
