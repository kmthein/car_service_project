  ...
  <script src='https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.5.2/js/bootstrap.min.js'></script>
    ...
    <div class="container-xxl py-5">
            ...
            <div class="container">
                    <div class="row">
                      <div class="col-lg">     
                        <iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d1909.338149572865!2d96.12680241469083!3d16.842407223032986!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1658894723151!5m2!1sen!2sbd" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>                      </div>
                      <div class="col-lg">
                        <h3 class="text-center text-secondary">Send Us A Message</h2><br>
                        ...
                        <?php                           
                            ...
                            if(isset($_POST['send'])){
                                ...
                                $result = mysqli_query($conn, "INSERT INTO `msg_box`(`user_name`, `email`, `subject`, `phone`, `message`) 
